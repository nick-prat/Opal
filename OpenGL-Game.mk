...
$(IntermediateDirectory)/src_utilities.cpp$(ObjectSuffix): src/utilities.cpp $(IntermediateDirectory)/src_utilities.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/nicholas/Documents/CodeLite Workspace/OpenGL-Project/src/utilities.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_utilities.cpp$(ObjectSuffix) $(IncludePath)
